...
/**
  * Customized from https://github.com/sksamuel/scrimage/blob/master/scrimage-core/src/main/scala/com/sksamuel/scrimage/color.scala
...
trait Color {
  ...
  /**
    ...
    */
  def toHex: String = "#" + Integer.toHexString(toRGB.toInt & 0xffffff)
    .toUpperCase.reverse.padTo(6, '0').reverse
}
...
object Color {
  ...
  def fromHex(color: String): Try[RGBColor] =
    Try(Integer.parseInt(color.substring(1), 16))
      .map(apply)
}
